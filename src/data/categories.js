...
export const CATEGORIES = [
  {
    ...
    keywords: [
      ...
      'supper', 'pho', 'curry', 'bakery', 'deli', 'food',
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      'nightcap', 'speakeasy', 'aperol', 'cheers',
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      'painting', 'theatre', 'theater', 'broadway', 'west end',
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      'heath', 'botanical', 'canyon', 'nature', 'waterfront', 'high line', 'rooftop garden',
    ],
  ...
  },
  {
    ...
    pitch: 'You put in the miles. Help a kid get their first pair of trainers.',
    keywords: [
  ...
  },
  {
    ...
    keywords: [
      ...
      'currently reading', 'author', 'poetry', 'zine',
    ],
  ...
  },
  {
    ...
    keywords: [
      ...
      'rescue cat', 'adopted', 'doggo', 'pupper',
    ],
